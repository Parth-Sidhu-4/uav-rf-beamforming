...
def main():
    ...
    model.load_state_dict(torch.load("siren_beamformer_d3_cov_K5_3D_dense.pt", map_location=device))
    model.eval()
    ...
    plt.tight_layout()
    plt.savefig('diag_180deg_pilot_3D_dense.png', dpi=120)
    plt.close()
