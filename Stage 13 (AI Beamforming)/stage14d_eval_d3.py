...
from stage14d_run_d3 import ShadowNetDB
...
def main():
    print("Evaluating Phase D-3 (shadow_net_d3.pt)")
    ...
    model.load_state_dict(torch.load("shadow_net_d3.pt", map_location=device))
    model.eval()
    ...
    print(f"Gain over Phase D-2 (13.60 dB): {(min_sinr_0 - 13.60):.2f} dB")
