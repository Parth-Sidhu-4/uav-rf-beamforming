...
def main():
    ...
    model = SIRENCovariancePredictor(w0=60.0, K_rank=K_RANK, hidden_dim=512).to(device)
    ...
    torch.save(model.state_dict(), "siren_beamformer_d3_cov_K5_3D_w60_h512.pt")
