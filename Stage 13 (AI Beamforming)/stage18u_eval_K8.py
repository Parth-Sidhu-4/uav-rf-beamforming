...
model = SIRENCovariancePredictor(w0=30.0, K_rank=8).to(device)
model.load_state_dict(torch.load('siren_beamformer_d3_cov_K8_100k_physics.pt', map_location=device))
model.eval()
