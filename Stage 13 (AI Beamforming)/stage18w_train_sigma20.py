...
class FourierEncoding(nn.Module):
    def __init__(self, in_features=3, out_features=256, sigma=20.0):
        super().__init__()
...
class ReluCovariancePredictor(nn.Module):
    def __init__(self, K_rank=5, hidden_dim=256):
        super().__init__()
        self.K = K_rank
        self.fourier = FourierEncoding(in_features=3, out_features=256, sigma=20.0)
...
def main():
    ...
    torch.save(model.state_dict(), 'relu_beamformer_d3_cov_K5_100k_sigma20.pt')
